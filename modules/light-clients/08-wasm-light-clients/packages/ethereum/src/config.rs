...
use crate::client_state::{Fork, ForkParameters};
...
pub const GOERLI: Config = Config {
    ...
    fork_parameters: ForkParameters {
        genesis_fork_version: FixedBytes([0, 0, 16, 32]),
        genesis_slot: (0),
        altair: Fork {
            version: FixedBytes([1, 0, 16, 32]),
            epoch: (36660),
        },
        bellatrix: Fork {
            version: FixedBytes([2, 0, 16, 32]),
            epoch: 112_260,
        },
        capella: Fork {
            version: FixedBytes([3, 0, 16, 32]),
            epoch: 162_304,
        },
        deneb: Fork {
            version: FixedBytes([4, 0, 16, 32]),
            epoch: 231_680,
        },
    },
...
pub const MAINNET: Config = Config {
    preset: preset::MAINNET,
    fork_parameters: ForkParameters {
        genesis_fork_version: FixedBytes([0, 0, 0, 0]),
        genesis_slot: 0,

        altair: Fork {
            version: FixedBytes([1, 0, 0, 0]),
            epoch: 74_240,
        },
        bellatrix: Fork {
            version: FixedBytes([2, 0, 0, 0]),
            epoch: 144_896,
        },
        capella: Fork {
            version: FixedBytes([3, 0, 0, 0]),
            epoch: 194_048,
        },
        // TODO: enabled march 13th 2024
        deneb: Fork {
            version: FixedBytes([4, 0, 0, 0]),
            epoch: u64::MAX,
        },
    },
...
pub const SEPOLIA: Config = Config {
    preset: preset::MAINNET,
    fork_parameters: ForkParameters {
        genesis_fork_version: FixedBytes([144, 0, 0, 105]),
        genesis_slot: 0,

        altair: Fork {
            version: FixedBytes([144, 0, 0, 112]),
            epoch: 50,
        },

        bellatrix: Fork {
            version: FixedBytes([144, 0, 0, 113]),
            epoch: 100,
        },

        capella: Fork {
            version: FixedBytes([144, 0, 0, 114]),
            epoch: 56_832,
        },

        deneb: Fork {
            version: FixedBytes([144, 0, 0, 115]),
            epoch: 132_608,
        },
    },
